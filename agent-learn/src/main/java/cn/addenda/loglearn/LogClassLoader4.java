...
/**
 * 将class的加载换成我自己的实现，但不继承URLClassLoader
 */
public class LogClassLoader4 extends ClassLoader {

  @Getter
  private static LogClassLoader4 DEFAULT_LOADER;
  ...
  public LogClassLoader4(ClassLoader parent) {
    super(parent);
...
//      ClassLoader extensionClassLoader = ClassLoader.getSystemClassLoader();
      DEFAULT_LOADER = new LogClassLoader4(extensionClassLoader);
    }
  }
