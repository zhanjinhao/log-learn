...
/**
 * 将class的加载换成我自己的实现，但依然继承URLClassLoader
 */
public class LogClassLoader3 extends URLClassLoader {

  @Getter
  private static LogClassLoader3 DEFAULT_LOADER;
  ...
  public LogClassLoader3(ClassLoader parent) {
...
//      ClassLoader extensionClassLoader = ClassLoader.getSystemClassLoader();
      DEFAULT_LOADER = new LogClassLoader3(extensionClassLoader);
    }
  }

  private Class<?> doFindClass(String name) throws ClassNotFoundException {
    System.out.println("doFindClass : " + name);
